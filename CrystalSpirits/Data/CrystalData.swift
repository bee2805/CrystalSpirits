...
func filterByColor(color: String) -> [Crystal]{
    var crystals: [Crystal] = []
    
    if(color == "SecondaryPink"){
        
        crystals.append( Crystal(image: "Carnelian",
            name: "Carnelian",
            color: "SecondaryPink",
            crystalSystem: "Triagonal",
            origin: "Braszil, Russia, India, Australia, ",
        ...
        crystals.append( Crystal(image: "RoseQuartz",
            name: "Rose Quartz",
            color: "SecondaryPink",
            crystalSystem: "Triagonal",
            origin: "South Africa, USA, Brazil, Japan, India",
        ...
        crystals.append(Crystal(image: "PinkSunstone",
            name: "Pink Sunstone",
            color: "Orange",
            crystalSystem: "Triclinic",
            origin: "USA",
        ...
        crystals.append(Crystal(image: "Citrine",
            name: "Citrine",
            color: "Yellow",
            crystalSystem: "Triagonal",
            origin: "North and South America, India",
        ...
        crystals.append(Crystal(image: "YellowTopaz",
            name: "Yellow Topaz",
            color: "Yellow",
            crystalSystem: "Orthorhombic",
            origin: "USA, Russia, Mexico, India, South Africa, Australia, Pakistan",
        ...
        crystals.append(Crystal(image: "Malachite",
            name: "Malachite",
            color: "Green",
            crystalSystem: "Monoclinic",
            origin: "USA(New Mexico), Australia, Zaire, France, Russia, Germany, Chile, Romania, Congo, Middle East",
        ...
        crystals.append(Crystal(image: "Moldavite",
                name: "Moldavite",
                color: "Green",
                crystalSystem: "Extraterrestrial",
                origin: "Czechoslovakia, Bavaria, Moldavia",
        ...
        crystals.append(Crystal(image: "BlueQuartz",
                name: "Blue Quartz",
                color: "SecondaryBlue",
                crystalSystem: "Hexagonal",
                origin: "Africa, England, USA, Russia",
        ...
        crystals.append(Crystal(image: "Turquoise",
                name: "Turquoise",
                color: "SecondaryBlue",
                crystalSystem: "Triclinic",
                origin: "USA, Egypt, Mexico, China, Iran, Peru, Poland",
    ...
    } else if (color == "SecondaryPurple"){
        crystals.append(Crystal(image: "RedGarnet",
                name: "Purple Garnet",
                color: "SecondaryPurple",
                crystalSystem: "Cubic",
                origin: "Europe, USA, South Africa, Australia",
        ...
        crystals.append(Crystal(image: "Amethyst",
                name: "Amethyst",
                color: "SecondaryPurple",
                crystalSystem: "Triagonal",
                origin: "Worldwide",
